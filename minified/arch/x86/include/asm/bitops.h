...
static __always_inline void arch___set_bit(long nr, volatile unsigned long *addr) {
	asm volatile(__ASM_SIZE(bts) " %1,%0" : : ADDR, "Ir" (nr) : "memory"); }

static __always_inline void arch_clear_bit(long nr, volatile unsigned long *addr) {
	if (__builtin_constant_p(nr)) {
...
static __always_inline bool arch_test_and_set_bit_lock(long nr, volatile unsigned long *addr) {
