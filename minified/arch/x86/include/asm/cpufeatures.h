...
/* X86_FEATURE_XMM3, PCLMULQDQ, DTES64 removed - unused */
#define X86_FEATURE_MWAIT		( 4*32+ 3)
/* X86_FEATURE_DSCPL, VMX, SMX, EST, TM2, SSSE3, CID, SDBG, FMA, CX16, XTPR, PDCM removed - unused */
#define X86_FEATURE_PCID		( 4*32+17)
#define X86_FEATURE_DCA			( 4*32+18)
/* X86_FEATURE_XMM4_1, XMM4_2, X2APIC, MOVBE, POPCNT removed - unused */
#define X86_FEATURE_TSC_DEADLINE_TIMER	( 4*32+24)
/* X86_FEATURE_AES removed - unused */  
#define X86_FEATURE_XSAVE		( 4*32+26)
#define X86_FEATURE_OSXSAVE		( 4*32+27)
/* X86_FEATURE_AVX, F16C, RDRAND removed - unused */
#define X86_FEATURE_HYPERVISOR		( 4*32+31)

/* X86_FEATURE_XSTORE, XSTORE_EN, XCRYPT, XCRYPT_EN, ACE2, ACE2_EN,
   PHE, PHE_EN, PMM, PMM_EN removed - unused */  
...
#define X86_BUG_RETBLEED		X86_BUG(26)  
