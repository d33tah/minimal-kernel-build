...
#define __copy_user(to,from,size) do { int __d0, __d1, __d2; __asm__ __volatile__( "	cmp  $7,%0\n" "	jbe  1f\n" "	movl %1,%0\n" "	negl %0\n" "	andl $7,%0\n" "	subl %0,%3\n" "4:	rep; movsb\n" "	movl %3,%0\n" "	shrl $2,%0\n" "	andl $3,%3\n" "	.align 2,0x90\n" "0:	rep; movsl\n" "	movl %3,%0\n" "1:	rep; movsb\n" "2:\n" _ASM_EXTABLE_TYPE_REG(4b, 2b, EX_TYPE_UCOPY_LEN1, %3) _ASM_EXTABLE_TYPE_REG(0b, 2b, EX_TYPE_UCOPY_LEN4, %3) _ASM_EXTABLE_UA(1b, 2b) : "=&c"(size), "=&D" (__d0), "=&S" (__d1), "=r"(__d2) : "3"(size), "0"(size), "1"(to), "2"(from) : "memory"); } while (0)
