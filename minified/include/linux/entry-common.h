...
#define SYSCALL_WORK_ENTER	(SYSCALL_WORK_SECCOMP |							 SYSCALL_WORK_SYSCALL_TRACEPOINT |					 SYSCALL_WORK_SYSCALL_TRACE |						 SYSCALL_WORK_SYSCALL_EMU |						 SYSCALL_WORK_SYSCALL_AUDIT |						 ARCH_SYSCALL_WORK_ENTER)
#define SYSCALL_WORK_EXIT	(SYSCALL_WORK_SYSCALL_TRACEPOINT |					 SYSCALL_WORK_SYSCALL_TRACE |						 SYSCALL_WORK_SYSCALL_AUDIT |						 SYSCALL_WORK_SYSCALL_EXIT_TRAP	|					 ARCH_SYSCALL_WORK_EXIT)
