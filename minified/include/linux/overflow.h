...
#define check_add_overflow(a, b, d) __must_check_overflow(({		typeof(a) __a = (a);				typeof(b) __b = (b);				typeof(d) __d = (d);				(void) (&__a == &__b);				(void) (&__a == __d);				__builtin_add_overflow(__a, __b, __d);	}))
