...
enum { IRQS_AUTODETECT		= 0x00000001, IRQS_SPURIOUS_DISABLED	= 0x00000002, IRQS_ONESHOT		= 0x00000020, IRQS_REPLAY		= 0x00000040, IRQS_WAITING		= 0x00000080, IRQS_PENDING		= 0x00000200, };

#include "debug.h"

/* --- 2025-12-08 02:25 --- Inlined from settings.h */
enum { _IRQ_DEFAULT_INIT_FLAGS	= IRQ_DEFAULT_INIT_FLAGS, _IRQ_NOPROBE		= IRQ_NOPROBE, _IRQ_NOREQUEST		= IRQ_NOREQUEST, _IRQ_NOTHREAD		= IRQ_NOTHREAD, _IRQ_NOAUTOEN		= IRQ_NOAUTOEN, _IRQ_NO_BALANCING	= IRQ_NO_BALANCING, _IRQ_PER_CPU_DEVID	= IRQ_PER_CPU_DEVID, _IRQ_DISABLE_UNLAZY	= IRQ_DISABLE_UNLAZY, _IRQF_MODIFY_MASK	= IRQF_MODIFY_MASK, };
