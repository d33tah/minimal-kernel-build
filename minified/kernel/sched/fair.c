 ...
 * values.
 */
#define sub_positive(_ptr,_val) do { typeof(_ptr) ptr = (_ptr); typeof(*ptr) val = (_val); typeof(*ptr) res, var = READ_ONCE(*ptr); res = var - val; if (res > var) res = 0; WRITE_ONCE(*ptr, res); } while (0)
 ...
 */
#define lsub_positive(_ptr,_val) do { typeof(_ptr) ptr = (_ptr); *ptr -= min_t(typeof(*ptr), *ptr, _val); } while (0)
