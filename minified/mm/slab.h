...
/* slub_percpu_partial, slub_set_percpu_partial, slub_percpu_partial_read_once removed - unused */
...
/* __kmem_cache_shutdown, __kmem_cache_release made static - only used in mm/slub.c */
