...
#define __cap_gained(field,target,source) !cap_issubset(target->cap_ ##field, source->cap_ ##field)
#define __cap_grew(target,source,cred) !cap_issubset(cred->cap_ ##target, cred->cap_ ##source)
